package com.usman.Spring.Boot.Ecommerce.controller;

import com.usman.Spring.Boot.Ecommerce.model.Product;
import com.usman.Spring.Boot.Ecommerce.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<String> updateProduct(@RequestPart Product product,@RequestPart MultipartFile imageFile){
        ...
        try {
            updateProduct = service.addProduct(product,imageFile);
